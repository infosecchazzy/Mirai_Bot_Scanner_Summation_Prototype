...
print "Total number of retransmission packets: %d" % total_non_unique_packets
print "-------------------------------------------------------------------------"
print "Total number of Bots: %d" % total_source_ip
print "Total number of potential Bot Victims: %d" % total_potential_new_bot_victims 
print "Total number of non-vulnerable Bot Victims: %d" % total_non_vuln_bot_victims
print "-------------------------------------------------------------------------"
print "Average packet delta time (seonds): %4.2f" % ( total_time_delta / ( total_packets - 1 ) )
